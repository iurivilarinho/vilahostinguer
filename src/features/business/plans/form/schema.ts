...
export const planFormSchema = z.object({
  ...
  cpuLimit: number("Informe as CPUs").min(0.1, "Mínimo de 0,1").max(64, "Máximo de 64"),
  memoryMb: number("Informe a memória").int("Número inteiro").min(64, "Mínimo de 64 MB").max(262_144, "Máximo de 256 GB"),
  diskGb: number("Informe o disco").int("Número inteiro").min(1, "Mínimo de 1 GB"),
