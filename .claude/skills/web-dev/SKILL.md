...
```yaml
argument-hint: implementation task, feature, refactor, or code change
tools:
  - read
  - search
  - edit
...
- Creating or editing a UI component → `component-creation`
- Creating or editing a form → `form-creation`
- Creating or editing an API hook or service → `api-integration`
- Deciding where a file lives → `feature-structure`
