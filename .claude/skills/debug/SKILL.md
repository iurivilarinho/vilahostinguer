...
```yaml
argument-hint: bug description, symptoms, logs, or related files
tools:
  - read
  - search
  - edit
...
- **Query key mismatch**: hook uses a different key structure than the invalidation — consult `api-integration` skill
